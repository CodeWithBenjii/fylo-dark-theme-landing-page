...
export default function App() {
  return (
    <div className="relative overflow-x-hidden">
      <nav className="container mx-auto flex justify-between align-center my-6">
        <img src={logo} alt="" />
      ...
      <section className="container mx-auto text-center flex flex-col items-center my-24 relative">
        <img src={heroImage} alt="" />
        <h1 className="text-3xl font-bold max-w-full md:max-w-[40rem] my-4">
          All your files in one secure location, accessible anywhere.
        </h1>
        <p className="font-sans text-xl opacity-60 max-w-full md:max-w-[36rem] ">
          Fylo stores all your most important files in one secure location.
          Access them wherever you need, share and collaborate with friends
          family, and co-workers.
        </p>
        <button className="custom-button my-4 w-full py-4 rounded-full max-w-full md:max-w-[17rem]">
          Get Started
        </button>
      </section>
      <div className="bg-[#191F2A]">
        <section className="container mx-auto my-40">
          <ul className="grid md:grid-cols-2 gap-20">
        ...
        <section className="container mx-auto grid md:grid-cols-2 gap-12 my-40 flow">
          <img src={swirl} className="w-full" alt="" />
          <div className="flow">
        ...
        <section className="container mx-auto">
          <ul className="grid md:grid-cols-3 gap-8 relative">
        ...
        <section className="max-w-[53rem] bg-[#1B2330] p-8 text-center mx-auto custom-shadow my-40 py-10 flow">
